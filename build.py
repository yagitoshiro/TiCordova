...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','org.selfkleptomaniac.ti.mod.ticordova.js')
	...
	f = os.path.join(cwd,'Classes','OrgSelfkleptomaniacTiModTicordovaModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','org.selfkleptomaniac.ti.mod.ticordova.js']
